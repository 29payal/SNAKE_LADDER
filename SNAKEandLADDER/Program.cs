namespace SNAKEandLADDER
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Choose option\n 1. Single player position\t 2.Rolls the Die\t 3.Player Check a for option\t 4.Repeat position till 100th\t 5. Exact winning position till 100th\t 6.Dice was played");
